...
@export_range(1.0, 2.0, 0.00001) var nebulae_displacement_multiplier: float = 1.1:
	set(value):
		if was_changed_event_emitted(&"nebulae_displacement_multiplier", value):
...
@export_range(1.0, 2.0, 0.00001) var stars_point_radius_multiplier: float = 1.0125:
	set(value):
		if was_changed_event_emitted(&"stars_point_radius_multiplier", value):
...
@export_range(1.0, 2.0, 0.00001) var stars_point_displacement_multiplier: float = 1.25:
	set(value):
		if was_changed_event_emitted(&"stars_point_displacement_multiplier", value):
...
@export_range(1.0, 2.0, 0.00001) var stars_field_radius_multiplier: float = 1.0125:
	set(value):
		if was_changed_event_emitted(&"stars_field_radius_multiplier", value):
...
@export_range(1.0, 2.0, 0.00001) var stars_field_displacement_multiplier: float = 1.025:
	set(value):
		if was_changed_event_emitted(&"stars_field_displacement_multiplier", value):
...
@export_range(1.0, 2.0, 0.00001) var void_radius_multiplier: float = 1.0125:
	set(value):
		if was_changed_event_emitted(&"void_radius_multiplier", value):
...
@export_range(-0.1, 0.1, 0.00001, "suffix:rad/s") var rotation_speed: float = 0.00025:
	set(value):
		if was_changed_event_emitted(&"rotation_speed", value):
...
@export_range(-2.0, 2.0, 0.00001) var stars_field_far_speed_multiplier: float = 1.0125:
	set(value):
		if was_changed_event_emitted(&"stars_field_far_speed_multiplier", value):
...
@export_range(-2.0, 2.0, 0.00001) var stars_field_near_speed_multiplier: float = 1.025:
	set(value):
		if was_changed_event_emitted(&"stars_field_near_speed_multiplier", value):
...
@export_range(-2.0, 2.0, 0.00001) var stars_point_far_speed_multiplier: float = 1.0:
	set(value):
		if was_changed_event_emitted(&"stars_point_far_speed_multiplier", value):
...
@export_range(-2.0, 2.0, 0.00001) var stars_point_mid_speed_multiplier: float = 1.005:
	set(value):
		if was_changed_event_emitted(&"stars_point_mid_speed_multiplier", value):
...
@export_range(-2.0, 2.0, 0.00001) var stars_point_near_speed_multiplier: float = 1.01:
	set(value):
		if was_changed_event_emitted(&"stars_point_near_speed_multiplier", value):
...
@export_range(-2.0, 2.0, 0.00001) var nebulae_speed_multiplier: float = 0.99:
	set(value):
		if was_changed_event_emitted(&"nebulae_speed_multiplier", value):
...
@export var nebulae_texture: Texture2D:
	set(value):
		if was_changed_event_emitted(&"nebulae_texture", value):
...
@export var nebulae_near_material: SkyboxLayerMaterial = SkyboxLayerMaterial.new(
	...
	set(value):
		if was_changed_event_emitted(&"nebulae_near_material", value):
...
@export var nebulae_mid_material: SkyboxLayerMaterial = SkyboxLayerMaterial.new(
	...
	set(value):
		if was_changed_event_emitted(&"nebulae_mid_material", value):
...
@export var nebulae_far_material: SkyboxLayerMaterial = SkyboxLayerMaterial.new(
	...
	set(value):
		if was_changed_event_emitted(&"nebulae_far_material", value):
...
@export var stars_point_near_material: SkyboxLayerMaterial = SkyboxLayerMaterial.new(
	...
	set(value):
		if was_changed_event_emitted(&"stars_point_near_material", value):
...
@export var stars_point_mid_material: SkyboxLayerMaterial = SkyboxLayerMaterial.new(
	...
	set(value):
		if was_changed_event_emitted(&"stars_point_mid_material", value):
...
@export var stars_point_far_material: SkyboxLayerMaterial = SkyboxLayerMaterial.new(
	...
	set(value):
		if was_changed_event_emitted(&"stars_point_far_material", value):
...
@export var stars_field_near_material: SkyboxLayerMaterial = SkyboxLayerMaterial.new(
	...
	set(value):
		if was_changed_event_emitted(&"stars_field_near_material", value):
...
@export var stars_field_far_material: SkyboxLayerMaterial = SkyboxLayerMaterial.new(
	...
	set(value):
		if was_changed_event_emitted(&"stars_field_far_material", value):
...
@export var stars_point_color_palette: GradientTexture1D:
	set(value):
		if was_changed_event_emitted(&"stars_point_color_palette", value):
...
@export var nebulae_dissolve_noise_texture: NoiseTexture2D:
	set(value):
		if was_changed_event_emitted(&"nebulae_dissolve_noise_texture", value):
...
@export var nebulae_near_dissolve: DissolveEffectSettings = DissolveEffectSettings.new(
	...
	set(value):
		if was_changed_event_emitted(&"nebulae_near_dissolve", value):
...
@export var nebulae_mid_dissolve: DissolveEffectSettings = DissolveEffectSettings.new(
	...
	set(value):
		if was_changed_event_emitted(&"nebulae_mid_dissolve", value):
...
@export var nebulae_far_dissolve: DissolveEffectSettings = DissolveEffectSettings.new(
	...
	set(value):
		if was_changed_event_emitted(&"nebulae_far_dissolve", value):
...
FlowMapDistortionEffectSettings.new(
	...
	set(value):
		if was_changed_event_emitted(&"nebulae_near_flow_map_distortion", value):
...
FlowMapDistortionEffectSettings.new(
	...
	set(value):
		if was_changed_event_emitted(&"nebulae_mid_flow_map_distortion", value):
...
FlowMapDistortionEffectSettings.new(
	...
	set(value):
		if was_changed_event_emitted(&"nebulae_far_flow_map_distortion", value):
...
@export var stars_point_near_twinkle: TwinkleEffectSettings = TwinkleEffectSettings.new(
	...
	set(value):
		if was_changed_event_emitted(&"stars_point_near_twinkle", value):
...
@export var stars_point_mid_twinkle: TwinkleEffectSettings = TwinkleEffectSettings.new(
	...
	set(value):
		if was_changed_event_emitted(&"stars_point_mid_twinkle", value):
...
@export var stars_point_far_twinkle: TwinkleEffectSettings = TwinkleEffectSettings.new(
	...
	set(value):
		if was_changed_event_emitted(&"stars_point_far_twinkle", value):
...
@export var nebulae_near_layer_visible: bool = true:
	set(value):
		if was_changed_event_emitted(&"nebulae_near_layer_visible", value):
...
@export var nebulae_mid_layer_visible: bool = true:
	set(value):
		if was_changed_event_emitted(&"nebulae_mid_layer_visible", value):
...
@export var nebulae_far_layer_visible: bool = true:
	set(value):
		if was_changed_event_emitted(&"nebulae_far_layer_visible", value):
...
@export var stars_point_near_layer_visible: bool = true:
	set(value):
		if was_changed_event_emitted(&"stars_point_near_layer_visible", value):
...
@export var stars_point_mid_layer_visible: bool = true:
	set(value):
		if was_changed_event_emitted(&"stars_point_mid_layer_visible", value):
...
@export var stars_point_far_layer_visible: bool = true:
	set(value):
		if was_changed_event_emitted(&"stars_point_far_layer_visible", value):
...
@export var stars_field_near_layer_visible: bool = true:
	set(value):
		if was_changed_event_emitted(&"stars_field_near_layer_visible", value):
...
@export var stars_field_far_layer_visible: bool = true:
	set(value):
		if was_changed_event_emitted(&"stars_field_far_layer_visible", value):
			stars_field_far_layer_visible = value

## Represents if the void layer is visible.
@export var void_layer_visible: bool = true:
	set(value):
		if was_changed_event_emitted(&"void_layer_visible", value):
